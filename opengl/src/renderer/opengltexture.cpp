...
#include "../stb_image/stb_image.h"
	...
	_2DTex::_2DTex(unsigned char* data)
	{
	...
	_2DTex::_2DTex(const std::string& texture_filePath, const std::string& name /*= "m_texture"*/, unsigned int format, unsigned internalFormat)
		:opengltexture()
	{
	...
	_2DTex::_2DTex(glenum internalFormat, glenum format, int width, int hieght)
		:opengltexture()
	{
	...
	void _2DTex::bindTextureToSlot(unsigned int slot /*= 0*/)
	{
	...
	openglCubeMaptexture::openglCubeMaptexture(std::array<_2DTex, 6> textures)
	{
		GLcall(glGenTextures(1, &m_rendererID));
		GLcall(glBindTexture(GL_TEXTURE_CUBE_MAP, m_rendererID));
